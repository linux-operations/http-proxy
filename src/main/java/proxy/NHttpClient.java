...
public class NHttpClient {
	...
	public static void main(String[] args) throws Exception {
		...
		BasicNIOConnFactory basicNIOConnFactory = new BasicNIOConnFactory(DefaultNHttpClientConnectionFactory.INSTANCE, connfactory);
		// Create HTTP connection pool
		BasicNIOConnPool pool = new BasicNIOConnPool(ioReactor, basicNIOConnFactory, 0);
